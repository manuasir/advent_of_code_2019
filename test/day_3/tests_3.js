...
describe('Day 3', () => {
  ...
  describe('Tests for the Manhattan distance calculation', () => {
    ...
    //   const result = panel.load()
    //   const minManhattanDistance = result.getMinColision()
    //   assert.equal(minManhattanDistance, 135)
    // })
    // it('Manhattan distance more complex custom', () => {
    //   const panel = new Panel([['U5','U47','R26','D63','R33','U87','L62','D20','R33','U53','R51'],['U98','R91','D20','R16','D67','R40','U7','R15','U6','R7']])
    //   const result = panel.load()
    //   const minManhattanDistance = result.getMinColision()
    //   assert.equal(minManhattanDistance, 135)
    // })
